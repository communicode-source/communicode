  ...
  <div>
    <div className={classNames('container-fluid', about.hero)}>
      ...
      <div id={about['for-good']} className="row">
        <div className={classNames('col-md-6', about['small-info-container'])}>
          <center>
            ...
            <div className={about['small-info']}>
              ...
              <p>Don't know any tech information about your project? Just give us a clear description and Communicode will figure out your needs.</p>
            </div>
        ...
        <div className={classNames('col-md-6', about['info-background'])}></div>
  		</div>
      ...
      <div id={about['for-good']} className="row">
  			...
  			<hr />
  			<p>As developers, we love passion-driven people like you. We’re here to help you find your next big project: build your skills, build your portfolio, build your community.</p>
  		</div>
      <div className="container">
