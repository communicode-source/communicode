...
const NotFound = () =>
    <div id={notFound['error-page']}>
        <Title render={parentTitle => `Page Not Found | ${parentTitle}`}/>
        <div className="container-fluid" id={notFound['error-page-container']}>
            <div className="row">
                <center><span id={notFound['error-404']}>404</span></center>
            </div>
            <div className="row">
                <div className="col-xs-12 col-md-6 col-md-push-3">
                    <center><span id={notFound['error-message']}>
