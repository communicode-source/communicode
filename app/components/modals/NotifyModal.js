            ...
            <div className={modal['modal-content']}>
                ...
                <div className="modal-body">
                    ...
                    <div className={classNames('input-group', modal['input-container'])}>
                        ...
                        <input type="text" className={classNames('form-control', modal.input)}
                               placeholder="boring@probablygmail.com" aria-describedby="basic-addon1"/>
                    </div>
                </div>
                <div className={classNames('modal-footer', modal.footer)}>
                    <button type="button" className={primaryBtnClassnames}>Help Us Change the World <i
